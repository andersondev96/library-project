            ...
            <div class="flex flex-wrap -mx-3 mb-4">
              <div class="w-full md:w-2/6 px-3 mb-4 md:mb:0">
                ...
                <input
                  ...
                  id="grid-birth_date" name="birth_date" type="date" value="{{ $client->birth_date }}" />
            ...
            <div class="flex flex-wrap -mx-3 mb-4">
              ...
              <div class="w-full md:w-2/6 px-3 mb-4 md:mb:0">
                ...
                <select
                  ...
                  <option value="Não se aplica" @if($client->department == 'Não se aplica') selected @endif>Não se aplica</option>
                </select>
