    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="bg-white border-b border-gray-200 h-60 w-full h-full">
          ...
          <form method="POST" action="{{ route('loans.store')}}" class="py-6 px-12 w-full w-full">
            ...
            <div class="flex flex-wrap -mx-3 mb-4">
              <div class="w-full md:w-2/6 px-3 mb-4 md:mb:0">
                ...
                <input
                  class="appearence-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-whrite {{$errors->has('books_id') ? 'focus:outline-none border-red-500' : ''}}"
                  type="text" id="grid-books_id" name="books_id" value="{{old('books_id')}}" list="books" />
                <datalist id="books">
                  @foreach($books as $b)
              ...
              <div class="w-full md:w-2/6 px-3 mb-4 md:mb:0">
                ...
                <input
                  class="appearence-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-whrite focus:border-gray-500 {{$errors->has('client_id') ? 'focus:outline-none border-red-500' : ''}}"
                  type="text" id="grid-client_id" name="client_id" value="{{old('client_id')}}" list="clients">
              ...
              <div class="w-full md:w-2/6 px-3 mb-4 md:mb:0">
                ...
                <div class="relative">
                  <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                    <svg
                      class="w-5 h-5 text-gray-500 {{$errors->has('delivery_date') ? 'focus:outline-none text-red-500' : ''}}"
                  ...
                  <input datepicker datepicker-autohide type="text" datepicker-format="yyyy-mm-dd"
                    ...
                    id="grid-delivery_date" name="delivery_date" value="{{old('delivery_date')}}"
