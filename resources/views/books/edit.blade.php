              ...
              <div class="w-full md:w-2/6 px-3 mb-4 md:mb:0">
                ...
                <div class="relative">
                  <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                    <svg
                      class="w-5 h-5 text-gray-500 {{$errors->has('publication_date') ? 'focus:outline-none text-red-500' : ''}}"
                  ...
                  <input datepicker datepicker-autohide type="text" datepicker-format="yyyy-mm-dd"
                    ...
                    id="grid-publication_date" name="publication_date" value="{{$book->publication_date}}"
